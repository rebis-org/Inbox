...
function joinAddresses(value: string | string[] | undefined): string | null {
...
function deferResend(
  ...
  execution.waitUntil(
    withRetry(
      ...
      logError('Deferred email delivery failed:', (error as Error).message);
    })
  );
}
...
export async function sendMail(
  ...
  const record: NewEmail = {
    ...
    cc: joinAddresses(body.cc),
    bcc: joinAddresses(body.bcc),
