...
export const mailboxMigrations: Migration[] = [
  ...
  {
    name: '10_add_trashed_at',
    sql: wrapInTransaction('ALTER TABLE emails ADD COLUMN trashed_at TEXT;')
  },
  {
    name: '11_add_sender_auth',
    sql: wrapInTransaction('ALTER TABLE emails ADD COLUMN sender_auth TEXT;')
  }
];
